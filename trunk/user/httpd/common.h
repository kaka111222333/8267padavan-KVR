...
//#define EVM_RESTART_EASYTIER			(1ULL << 38) // Easyier异地组网【新删除】
...
//#define EVM_RESTART_CLOUDFLARE		(1ULL << 41)  //CF的ddns【新删除】
...
//#define EVM_RESTART_ALIDDNS			(1ULL << 45) //阿里ddns【删除】
...
//#define EVM_RESTART_CADDY			(1ULL << 48) //caddy文件管理【删除】
#define EVM_RESTART_SS_TUNNEL		(1ULL << 49) //科学上网插件【新增】
//#define EVM_RESTART_ADGUARDHOME		(1ULL << 49) //adg去广告【删除】
//#define EVM_RESTART_MENTOHUST		(1ULL << 50) //校园认证
//#define EVM_RESTART_WYY			(1ULL << 50) //网易云
//#define EVM_RESTART_BAFA			(1ULL << 50) //巴法云【新删除】
...
//#define EVM_RESTART_WIREGUARD			(1ULL << 52) //wg异地组网【新删除】
//#define EVM_RESTART_ALDRIVER			(1ULL << 53) //阿里云盘挂载【新删除】
//#define EVM_RESTART_UUPLUGIN			(1ULL << 54) //UU加速器【新删除】
//#define EVM_RESTART_KOOLPROXY		(1ULL << 55) //kp去广告
//#define EVM_RESTART_LUCKY			(1ULL << 55) //lucky【新删除】
//#define EVM_RESTART_WXSEND			(1ULL << 56) //微信推送【删除】
//#define EVM_RESTART_CLOUDFLARED		(1ULL << 57) //CF隧道免费内网穿透【新删除】
#define EVM_RESTART_VNTS			(1ULL << 58) //vnt服务器
#define EVM_RESTART_VNTCLI			(1ULL << 59) //vnt客户端
//#define EVM_RESTART_NVPPROXY		(1ULL << 60) 
//#define EVM_RESTART_NATPIERCE			(1ULL << 60) //皎月连【新删除】
//#define EVM_RESTART_TAILSCALE			(1ULL << 61) //taislacle【新删除】
